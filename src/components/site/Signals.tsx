...
const signals = [
  {
    title: "Signaux Bitcoin", asset: "BTC/USDT", icon: Bitcoin,
    accent: "from-amber-400 to-orange-500",
    entry: "64,820", tp: "68,420", sl: "62,950", conf: 94, risk: "Faible", ret: "+5.5%",
  },
  {
    title: "Signaux Ethereum", asset: "ETH/USDT", icon: Coins,
    accent: "from-indigo-400 to-violet-500",
    entry: "3,420", tp: "3,720", sl: "3,290", conf: 91, risk: "Faible", ret: "+8.7%",
  },
  {
    title: "Opportunités Altcoins", asset: "SOL/USDT", icon: Layers,
    accent: "from-fuchsia-400 to-pink-500",
    entry: "168.40", tp: "192.80", sl: "159.10", conf: 88, risk: "Moyen", ret: "+14.5%",
  },
  {
    title: "Transactions Scalp", asset: "LINK/USDT", icon: Zap,
    accent: "from-emerald-400 to-teal-500",
    entry: "18.42", tp: "19.05", sl: "18.10", conf: 89, risk: "Faible", ret: "+3.4%",
  },
  {
    title: "Transactions Swing", asset: "AVAX/USDT", icon: LineChart,
    accent: "from-sky-400 to-blue-600",
    entry: "42.10", tp: "51.80", sl: "39.20", conf: 86, risk: "Moyen", ret: "+22.8%",
  },
  {
    title: "Configurations à long terme", asset: "BNB/USDT", icon: Timer,
    accent: "from-rose-400 to-red-500",
    entry: "612.50", tp: "740.00", sl: "562.00", conf: 92, risk: "Moyen", ret: "+20.8%",
  },
];
      ...
      <div className="container-page">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-4 font-display text-3xl font-bold tracking-tight text-ink md:text-4xl lg:text-5xl lg:leading-[1.05]">
            Des signaux conçus pour chaque type de trader
          </h2>
          <p className="mt-5 text-lg text-ink-soft">
            Des entrées en temps réel avec des paramètres de risque précis. Chaque signal est évalué
            par notre score de confiance neuronal avant d'atteindre votre téléphone.
          </p>
        </div>
          ...
          {signals.map((s) => (
            ...
            >
              ...
              <div className="mt-6 grid grid-cols-3 gap-2">
                <Mini label="Entrée" value={`$${s.entry}`} />
              ...
              <div className="mt-5 flex items-center justify-between border-t border-black/5 pt-4">
                <span className="text-xs text-ink-soft">Niveau de risque</span>
